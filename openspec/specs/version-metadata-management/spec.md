# version-metadata-management Specification

## Purpose
Defines how Sentinel resolves and exposes runtime version metadata across release and local builds.
...
#### Scenario: Untagged build has fallback metadata
