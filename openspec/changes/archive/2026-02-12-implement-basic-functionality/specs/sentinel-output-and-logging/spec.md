...
Sentinel SHALL default to human-oriented pretty output for CLI status and diff presentation using deterministic formatting rules.
...
Sentinel SHALL provide a JSON log format option that emits structured fields suitable for machine ingestion.
